...
book1 = Book(1, "Wings of Fire", "A.P.J.Abdul Kalam")
book2 = Book(2, "The power of subconscious mind", "charles heugg")
book3 = Book(3, "Advanced Data Structures", "Reema Thareja")
...
member1 = Member(101, "XYZ")
member2 = Member(102, "ABC", False)

library_system.add_member(member1)
library_system.add_member(member2)

library_system.borrow_book(101, 1)  
library_system.borrow_book(102, 2)  
library_system.borrow_book(103, 3) 
